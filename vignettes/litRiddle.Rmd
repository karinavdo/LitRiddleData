...
**NOTE**: The dplyr package hides the `explain` function from the package litRiddle because it has its own `explain` function. To use litRiddle's explain function after `dplyr` is loaded, call it explicitly, like so: `litRiddle::explain( "books" )`.
